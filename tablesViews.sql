...
drop view if exists survey_rate_view cascade;
create view survey_rate_view as
	select surveys.id as surveyid,surveys.survey,rates.id as rateid,
	rates.rate from surveys join rates on surveys.id=rates.survey_id;
